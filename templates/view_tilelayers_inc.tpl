...
<div id="view_tilelayers">
	<div class="row">
		...
		{forminput}
			<select name="theme_id" id="theme_id" onchange="BitMap.EditSession.getTilelayers(this,'');">
	...
	{include file="bitpackage:gmap/jspagination.tpl" ajaxHandler="BitMap.EditSession.getTilelayers" ajaxInputId="theme_id"}
</div>
{/strip}
